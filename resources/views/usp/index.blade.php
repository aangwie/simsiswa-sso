...
@section('title', 'Nilai USP - SIMSiswa')
...
<div class="space-y-6">
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 class="text-xl font-bold text-slate-800">Nilai USP (Ujian Satuan Pendidikan)</h1>
            <p class="text-sm text-slate-500 mt-1">Pilih kelas di bawah ini untuk memulai pengisian nilai USP.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <a href="{{ route('usp.show', $class->id) }}" class="group bg-white rounded-2xl p-6 shadow-sm border border-slate-100 transition-all hover:shadow-md hover:border-indigo-100 relative overflow-hidden flex flex-col h-full">
