...
<body
    ...
    <div class="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div
            class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-indigo-600/5 blur-[150px]">
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex space-x-4 items-center">
                    <a href="{{ route('cek-kelulusan') }}" class="px-3 py-2 rounded-md text-sm font-medium text-white bg-white/10 transition">Cek SKL</a>
                ...
                <div class="md:hidden flex items-center" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" class="absolute top-20 left-0 w-full bg-slate-900 border-b border-white/10 shadow-xl" style="display: none;">
                        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                            <a href="{{ route('cek-kelulusan') }}" class="block px-3 py-2 rounded-md text-base font-medium text-white bg-white/10">Cek SKL</a>
    ...
    <div class="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 relative z-10 -mt-10">
        ...
        <div class="text-center mb-8 animate-fadeInUp">
            <div
                class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 shadow-2xl shadow-indigo-500/40 mb-6 pulse-glow">
            ...
            <h1 class="text-3xl sm:text-4xl font-extrabold tracking-tight">
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-white via-indigo-200 to-purple-200">Cek
                    Kelulusan Siswa</span>
            </h1>
        ...
        <div class="w-full max-w-md animate-fadeInUp-delay">
            <div
                class="bg-white/[0.07] backdrop-blur-2xl rounded-3xl border border-white/10 shadow-2xl shadow-black/20 p-8 sm:p-10">
                ...
                <form action="{{ route('cek-kelulusan.check') }}" method="POST" class="space-y-6"
                    id="form-cek-kelulusan">
                    @csrf

                    <!-- NIS / NISN -->
                    <div>
                        <label for="identifier" class="block text-sm font-semibold text-indigo-100 mb-2">NIS /
                            NISN</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-indigo-300/50" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <!-- Tanggal Lahir -->
                    <div>
                        <label for="tanggal_lahir" class="block text-sm font-semibold text-indigo-100 mb-2">Tanggal
                            Lahir</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-indigo-300/50" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <!-- Submit Button -->
                    <div>
                        <button type="submit" id="btn-cek-kelulusan"
