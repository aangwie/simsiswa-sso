        ...
        <div class="flex flex-col md:flex-row items-left justify-between gap-4">
            ...
            <div class="flex items-center gap-2 w-full md:w-auto justify-end">
                @if($students->isNotEmpty())
                    <a href="{{ route('skl.cetak.class_pdf', ['class' => $class->id]) }}" target="_blank"
                        class="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-xl transition-all shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
